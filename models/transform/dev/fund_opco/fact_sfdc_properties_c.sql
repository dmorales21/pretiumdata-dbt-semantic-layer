-- TRANSFORM.DEV.FACT_SFDC_PROPERTIES_C — read-through of SOURCE_ENTITY.PROGRESS.SFDC_PROPERTIES__C
-- SFDC_PROPERTIES__C property spine ↔ Yardi
...
SELECT *
FROM {{ source('source_entity_progress', 'sfdc_properties__c') }}
