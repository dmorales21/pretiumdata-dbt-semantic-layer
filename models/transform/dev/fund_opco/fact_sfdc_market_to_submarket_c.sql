-- TRANSFORM.DEV.FACT_SFDC_MARKET_TO_SUBMARKET_C — read-through of SOURCE_ENTITY.PROGRESS.SFDC_MARKET_TO_SUBMARKET__C
-- SFDC_MARKET_TO_SUBMARKET__C bridge
...
{{ config(
    materialized='view',
    alias='fact_sfdc_market_to_submarket_c',
...
SELECT *
FROM {{ source('source_entity_progress', 'sfdc_market_to_submarket__c') }}
