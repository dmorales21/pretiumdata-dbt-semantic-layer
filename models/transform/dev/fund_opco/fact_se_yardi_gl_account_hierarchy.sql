-- TRANSFORM.DEV.FACT_SE_YARDI_GL_ACCOUNT_HIERARCHY — read-through SOURCE_ENTITY.PROGRESS.YARDI_ACCTTREE
-- Chart of accounts / GL hierarchy (Returns).
...
{{ config(
    materialized='view',
    alias='fact_se_yardi_gl_account_hierarchy',
...
SELECT *
FROM {{ source('source_entity_progress', 'yardi_accttree') }}
