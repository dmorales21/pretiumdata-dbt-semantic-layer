-- TRANSFORM.DEV.FACT_SFDC_FUND_PIPELINE_SUMMARY_C — read-through of SOURCE_ENTITY.PROGRESS.SFDC_FUND_PIPELINE_SUMMARY__C
-- SFDC_FUND_PIPELINE_SUMMARY__C rollups
...
{{ config(
    materialized='view',
    alias='fact_sfdc_fund_pipeline_summary_c',
...
SELECT *
FROM {{ source('source_entity_progress', 'sfdc_fund_pipeline_summary__c') }}
