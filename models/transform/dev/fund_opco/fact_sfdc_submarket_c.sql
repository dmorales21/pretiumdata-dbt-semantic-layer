-- TRANSFORM.DEV.FACT_SFDC_SUBMARKET_C — read-through of SOURCE_ENTITY.PROGRESS.SFDC_SUBMARKET__C
-- SFDC_SUBMARKET__C submarket definitions
...
SELECT *
FROM {{ source('source_entity_progress', 'sfdc_submarket__c') }}
