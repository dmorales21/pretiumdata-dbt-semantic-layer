-- TRANSFORM.DEV.FACT_SFDC_ACQUISITION_C — read-through of SOURCE_ENTITY.PROGRESS.SFDC_ACQUISITION__C
-- SFDC_ACQUISITION__C acquisition economics
...
SELECT *
FROM {{ source('source_entity_progress', 'sfdc_acquisition__c') }}
