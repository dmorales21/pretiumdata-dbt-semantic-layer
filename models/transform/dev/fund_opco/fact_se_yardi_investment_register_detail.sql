-- TRANSFORM.DEV.FACT_SE_YARDI_INVESTMENT_REGISTER_DETAIL — read-through SOURCE_ENTITY.PROGRESS.YARDI_GLINVREGDETAIL
-- Investment register and capex register lines (Returns).
...
{{ config(
    materialized='view',
    alias='fact_se_yardi_investment_register_detail',
...
SELECT *
FROM {{ source('source_entity_progress', 'yardi_glinvregdetail') }}
