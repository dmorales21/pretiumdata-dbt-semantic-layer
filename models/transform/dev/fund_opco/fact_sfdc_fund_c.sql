-- TRANSFORM.DEV.FACT_SFDC_FUND_C — read-through of SOURCE_ENTITY.PROGRESS.SFDC_FUND__C
-- SFDC_FUND__C fund header (Allocate)
...
SELECT *
FROM {{ source('source_entity_progress', 'sfdc_fund__c') }}
