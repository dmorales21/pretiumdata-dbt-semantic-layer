-- TRANSFORM.DEV.FACT_SFDC_FUND_MARKET_C — read-through of SOURCE_ENTITY.PROGRESS.SFDC_FUND_MARKET__C
-- SFDC_FUND_MARKET__C fund × market (Allocate)
...
SELECT *
FROM {{ source('source_entity_progress', 'sfdc_fund_market__c') }}
