-- TRANSFORM.DEV.FACT_SFDC_ACQUISITION_HISTORY — read-through of SOURCE_ENTITY.PROGRESS.SFDC_ACQUISITION__HISTORY
-- SFDC_ACQUISITION__HISTORY stage velocity
...
{{ config(
    materialized='view',
    alias='fact_sfdc_acquisition_history',
...
SELECT *
FROM {{ source('source_entity_progress', 'sfdc_acquisition__history') }}
