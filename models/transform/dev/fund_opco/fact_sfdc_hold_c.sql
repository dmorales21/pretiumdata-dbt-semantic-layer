-- TRANSFORM.DEV.FACT_SFDC_HOLD_C — read-through of SOURCE_ENTITY.PROGRESS.SFDC_HOLD__C
-- SFDC_HOLD__C hold / pause
...
SELECT *
FROM {{ source('source_entity_progress', 'sfdc_hold__c') }}
