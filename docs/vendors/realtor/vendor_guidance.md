# Realtor.com — Data Guidance

⚠️ **INTERNAL — contract and operational context**

**Intake bundle:** `docs/vendors/realtor/` (machine column inventory + this narrative).  
**Canonical vendor hub:** `docs/vendor/realtor/` (dictionary + structured stubs).
...
| **vendor_id** | `VND_010` |
| **vendor_code** | `realtor` |
| **vendor_label** | Realtor.com |
| **definition** | Realtor.com inventory hotness and listing metrics at MSA and ZIP grain |
| **data_type** | transactional |
| **refresh_cadence** | weekly |
| **contract_status** | active |
| **source_schema** | `RAW.REALTOR` |
| **data_share_type** | s3 |
| **vertical_codes** | — |
...
## Vendor methodology (full text from `docs/vendor/realtor/realtor.md`)

**Catalog row:** `vendor_id` = `VND_010` in `seeds/reference/catalog/vendor.csv`.

## 1. Identity

Realtor.com inventory hotness and listing metrics at MSA and ZIP grain
...
See [VENDOR_CONCEPT_COVERAGE_MATRIX.md](../migration/VENDOR_CONCEPT_COVERAGE_MATRIX.md) for **`realtor`** × concept × dataset gaps and stretch mappings.
...
|-----------|--------------|--------|-----------|------------|------------------|
| SEM_CANON_REALTOR_INVENTORY_CBSA_VALUE_OBSERVE | listings | housing | neutral | `TRANSFORM.DEV.FACT_REALTOR_INVENTORY_CBSA` | `VALUE` |
| MET_108 | listings | housing | neutral | `TRANSFORM.DEV.fact_realtor_inventory_cbsa` | `VALUE` |
