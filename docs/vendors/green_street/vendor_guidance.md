# Green Street Advisors — Data Guidance

⚠️ **INTERNAL — contract and operational context**

**Intake bundle:** `docs/vendors/green_street/` (machine column inventory + this narrative).  
**Canonical vendor hub:** `docs/vendor/green_street/` (dictionary + structured stubs).
...
|-------|-------|
| **vendor_id** | `VND_017` |
| **vendor_code** | `green_street` |
| **vendor_label** | Green Street Advisors |
| **definition** | Green Street market projections HPA scenarios macro rates fundamental valuation and US debt data covering CMBS ABS and high yield |
| **data_type** | survey |
| **refresh_cadence** | quarterly |
| **contract_status** | active |
| **source_schema** | `RAW.GREEN_STREET` |
| **data_share_type** | s3 |
| **vertical_codes** | — |
...
## Vendor methodology (full text from `docs/vendor/green_street/green_street.md`)

**Catalog row:** `vendor_id` = `VND_017` in `seeds/reference/catalog/vendor.csv`.

## 1. Identity

Green Street market projections HPA scenarios macro rates fundamental valuation and US debt data covering CMBS ABS and high yield
...
See [VENDOR_CONCEPT_COVERAGE_MATRIX.md](../migration/VENDOR_CONCEPT_COVERAGE_MATRIX.md) for **`green_street`** × concept × dataset gaps and stretch mappings.
...
|-----------|--------------|--------|-----------|------------|------------------|
| GREEN_STREET_MAN_3E7B52D5 | pipeline | place | neutral | `RAW.GREEN_STREET` | `TBD` |
