# NCES — National Center for Education Statistics — Data Guidance

⚠️ **INTERNAL — contract and operational context**

**Intake bundle:** `docs/vendors/education_nces/` (machine column inventory + this narrative).  
**Canonical vendor hub:** `docs/vendor/education_nces/` (dictionary + structured stubs).
...
|-------|-------|
| **vendor_id** | `VND_036` |
| **vendor_code** | `education_nces` |
| **vendor_label** | NCES — National Center for Education Statistics |
| **definition** | K-12 public school data from EDGE and CCD covering school locations characteristics enrollment and geocoded addresses |
| **data_type** | administrative |
| **refresh_cadence** | annual |
| **contract_status** | active |
| **source_schema** | `RAW.EDUCATION` |
| **data_share_type** | s3 |
| **vertical_codes** | — |
...
## Vendor methodology (full text from `docs/vendor/education_nces/education_nces.md`)

**Catalog row:** `vendor_id` = `VND_036` in `seeds/reference/catalog/vendor.csv`.

## 1. Identity

K-12 public school data from EDGE and CCD covering school locations characteristics enrollment and geocoded addresses
...
See [VENDOR_CONCEPT_COVERAGE_MATRIX.md](../migration/VENDOR_CONCEPT_COVERAGE_MATRIX.md) for **`education_nces`** × concept × dataset gaps and stretch mappings.
...
|-----------|--------------|--------|-----------|------------|------------------|
| EDUCATION_NC_MAN_36873DE6 | pipeline | place | neutral | `RAW.EDUCATION` | `TBD` |
