# Parcl Labs — Data Guidance

⚠️ **INTERNAL — contract and operational context**

**Intake bundle:** `docs/vendors/parcllabs/` (machine column inventory + this narrative).  
**Canonical vendor hub:** `docs/vendor/parcllabs/` (dictionary + structured stubs).
...
|-------|-------|
| **vendor_id** | `VND_016` |
| **vendor_code** | `parcllabs` |
| **vendor_label** | Parcl Labs |
| **definition** | Parcl Labs SFR housing stock ownership demand pricing supply and institutional ownership analytics at CBSA and ZIP grain |
...
## Vendor methodology (full text from `docs/vendor/parcllabs/parcllabs.md`)
...
|-----------|--------------|--------|-----------|------------|------------------|
| PARCLLABS_MAN_8E3669B6 | pipeline | place | neutral | `RAW.PARCLLABS` | `TBD` |
