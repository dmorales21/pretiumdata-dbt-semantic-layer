# Overture Maps — Data Guidance

⚠️ **INTERNAL — contract and operational context**

**Intake bundle:** `docs/vendors/overture/` (machine column inventory + this narrative).  
**Canonical vendor hub:** `docs/vendor/overture/` (dictionary + structured stubs).
...
|-------|-------|
| **vendor_id** | `VND_022` |
| **vendor_code** | `overture` |
| **vendor_label** | Overture Maps |
| **definition** | Overture Maps open geospatial data covering POI places building footprints land use and transportation |
| **data_type** | spatial |
| **refresh_cadence** | annual |
| **contract_status** | active |
| **source_schema** | `RAW.OVERTURE` |
...
## Vendor methodology (full text from `docs/vendor/overture/overture.md`)

**Catalog row:** `vendor_id` = `VND_022` in `seeds/reference/catalog/vendor.csv`.

## 1. Identity

Overture Maps open geospatial data covering POI places building footprints land use and transportation
...
See [VENDOR_CONCEPT_COVERAGE_MATRIX.md](../migration/VENDOR_CONCEPT_COVERAGE_MATRIX.md) for **`overture`** × concept × dataset gaps and stretch mappings.
...
|-----------|--------------|--------|-----------|------------|------------------|
| OVERTURE_MAN_29F4468B | pipeline | place | neutral | `RAW.OVERTURE` | `TBD` |
