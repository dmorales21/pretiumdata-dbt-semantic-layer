# Selene Finance — Data Guidance

⚠️ **INTERNAL — contract and operational context**

**Intake bundle:** `docs/vendors/selene/` (machine column inventory + this narrative).  
**Canonical vendor hub:** `docs/vendor/selene/` (dictionary + structured stubs).
...
| **vendor_id** | `VND_034` |
| **vendor_code** | `selene` |
| **vendor_label** | Selene Finance |
| **definition** | Selene Finance servicer-level property data for RED mortgage servicing portfolio |
| **data_type** | operational |
| **refresh_cadence** | monthly |
| **contract_status** | active |
| **source_schema** | `SOURCE_ENTITY.SELENE` |
...
## Vendor methodology (full text from `docs/vendor/selene/selene.md`)

**Catalog row:** `vendor_id` = `VND_034` in `seeds/reference/catalog/vendor.csv`.

## 1. Identity

Selene Finance servicer-level property data for RED mortgage servicing portfolio
...
See [VENDOR_CONCEPT_COVERAGE_MATRIX.md](../migration/VENDOR_CONCEPT_COVERAGE_MATRIX.md) for **`selene`** × concept × dataset gaps and stretch mappings.
...
|-----------|--------------|--------|-----------|------------|------------------|
| SELENE_MAN_F785A956 | pipeline | place | neutral | `SOURCE_ENTITY.SELENE` | `TBD` |
