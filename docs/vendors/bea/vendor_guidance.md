# Bureau of Economic Analysis — Data Guidance

⚠️ **INTERNAL — contract and operational context**

**Intake bundle:** `docs/vendors/bea/` (machine column inventory + this narrative).  
**Canonical vendor hub:** `docs/vendor/bea/` (dictionary + structured stubs).
...
| **vendor_id** | `VND_041` |
| **vendor_code** | `bea` |
| **vendor_label** | Bureau of Economic Analysis |
| **definition** | BEA regional and national economic accounts (GDP personal income RPP employment-by-industry). Not Cybersyn; register metrics against BEA-native or Pretium-typed FACT paths when landed |
| **data_type** | administrative |
| **refresh_cadence** | quarterly |
| **contract_status** | active |
| **source_schema** | `RAW.BEA` |
| **data_share_type** | s3 |
| **vertical_codes** | — |
...
## Vendor methodology (full text from `docs/vendor/bea/bea.md`)

**Catalog row:** `vendor_id` = `VND_041` in `seeds/reference/catalog/vendor.csv`.

## 1. Identity

BEA regional and national economic accounts (GDP personal income RPP employment-by-industry). Not Cybersyn; register metrics against BEA-native or Pretium-typed FACT paths when landed
...
See [VENDOR_CONCEPT_COVERAGE_MATRIX.md](../migration/VENDOR_CONCEPT_COVERAGE_MATRIX.md) for **`bea`** × concept × dataset gaps and stretch mappings.
...
|-----------|--------------|--------|-----------|------------|------------------|
| BEA_MAN_B7026663 | pipeline | place | neutral | `RAW.BEA` | `TBD` |
