# John Burns Research & Consulting — Data Guidance

⚠️ **INTERNAL — contract and operational context**

**Intake bundle:** `docs/vendors/jbrec/` (machine column inventory + this narrative).  
**Canonical vendor hub:** `docs/vendor/jbrec/` (dictionary + structured stubs).
...
| **vendor_id** | `VND_019` |
| **vendor_code** | `jbrec` |
| **vendor_label** | John Burns Research & Consulting |
| **definition** | JBREC SFR multifamily BTR and national housing research data at CBSA and national grain |
| **data_type** | survey |
| **refresh_cadence** | monthly |
| **contract_status** | active |
| **source_schema** | `RAW.JBREC` |
| **data_share_type** | s3 |
| **vertical_codes** | — |
...
## Vendor methodology (full text from `docs/vendor/jbrec/jbrec.md`)

**Catalog row:** `vendor_id` = `VND_019` in `seeds/reference/catalog/vendor.csv`.

## 1. Identity

JBREC SFR multifamily BTR and national housing research data at CBSA and national grain
...
See [VENDOR_CONCEPT_COVERAGE_MATRIX.md](../migration/VENDOR_CONCEPT_COVERAGE_MATRIX.md) for **`jbrec`** × concept × dataset gaps and stretch mappings.
...
|-----------|--------------|--------|-----------|------------|------------------|
| JBREC_MAN_C2921134 | pipeline | place | neutral | `RAW.JBREC` | `TBD` |
