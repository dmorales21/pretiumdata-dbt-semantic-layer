# Preqin — Data Guidance

⚠️ **INTERNAL — contract and operational context**

**Intake bundle:** `docs/vendors/preqin/` (machine column inventory + this narrative).  
**Canonical vendor hub:** `docs/vendor/preqin/` (dictionary + structured stubs).
...
| **vendor_code** | `preqin` |
| **vendor_label** | Preqin |
| **definition** | Preqin private markets news and intelligence data |
| **data_type** | survey |
| **refresh_cadence** | daily |
| **contract_status** | active |
| **source_schema** | `RAW.NEWS` |
| **data_share_type** | api |
| **vertical_codes** | — |
...
## Vendor methodology (full text from `docs/vendor/preqin/preqin.md`)

**Catalog row:** `vendor_id` = `VND_035` in `seeds/reference/catalog/vendor.csv`.

## 1. Identity

Preqin private markets news and intelligence data
...
See [VENDOR_CONCEPT_COVERAGE_MATRIX.md](../migration/VENDOR_CONCEPT_COVERAGE_MATRIX.md) for **`preqin`** × concept × dataset gaps and stretch mappings.
...
|-----------|--------------|--------|-----------|------------|------------------|
| PREQIN_MAN_2F36F353 | pipeline | place | neutral | `RAW.NEWS` | `TBD` |
