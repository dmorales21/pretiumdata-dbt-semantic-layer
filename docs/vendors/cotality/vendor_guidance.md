# Cotality — Data Guidance

⚠️ **INTERNAL — contract and operational context**

**Intake bundle:** `docs/vendors/cotality/` (machine column inventory + this narrative).  
**Canonical vendor hub:** `docs/vendor/cotality/` (dictionary + structured stubs).
...
|-------|-------|
| **vendor_id** | `VND_020` |
| **vendor_code** | `cotality` |
| **vendor_label** | Cotality |
| **definition** | Cotality crime and school quality tract-level time series data |
| **data_type** | transactional |
| **refresh_cadence** | annual |
| **contract_status** | active |
| **source_schema** | `RAW.COTALITY` |
| **data_share_type** | s3 |
| **vertical_codes** | — |
...
## Vendor methodology (full text from `docs/vendor/cotality/cotality.md`)

**Catalog row:** `vendor_id` = `VND_020` in `seeds/reference/catalog/vendor.csv`.

## 1. Identity

Cotality crime and school quality tract-level time series data
...
See [VENDOR_CONCEPT_COVERAGE_MATRIX.md](../migration/VENDOR_CONCEPT_COVERAGE_MATRIX.md) for **`cotality`** × concept × dataset gaps and stretch mappings.
...
|-----------|--------------|--------|-----------|------------|------------------|
| COTALITY_MAN_71A28570 | pipeline | place | neutral | `RAW.COTALITY` | `TBD` |
