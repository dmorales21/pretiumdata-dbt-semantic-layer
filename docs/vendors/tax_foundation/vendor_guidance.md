# Tax Foundation — Data Guidance

⚠️ **INTERNAL — contract and operational context**

**Intake bundle:** `docs/vendors/tax_foundation/` (machine column inventory + this narrative).  
**Canonical vendor hub:** `docs/vendor/tax_foundation/` (dictionary + structured stubs).
...
|-------|-------|
| **vendor_id** | `VND_026` |
| **vendor_code** | `tax_foundation` |
| **vendor_label** | Tax Foundation |
| **definition** | Tax Foundation property tax rates by county and state covering effective rates and collections |
| **data_type** | administrative |
| **refresh_cadence** | annual |
| **contract_status** | active |
| **source_schema** | `RAW.TAX_FOUNDATION` |
| **data_share_type** | s3 |
| **vertical_codes** | — |
...
## Vendor methodology (full text from `docs/vendor/tax_foundation/tax_foundation.md`)

**Catalog row:** `vendor_id` = `VND_026` in `seeds/reference/catalog/vendor.csv`.

## 1. Identity

Tax Foundation property tax rates by county and state covering effective rates and collections
...
See [VENDOR_CONCEPT_COVERAGE_MATRIX.md](../migration/VENDOR_CONCEPT_COVERAGE_MATRIX.md) for **`tax_foundation`** × concept × dataset gaps and stretch mappings.
...
|-----------|--------------|--------|-----------|------------|------------------|
| TAX_FOUNDATI_MAN_2FA0DBE6 | pipeline | place | neutral | `RAW.TAX_FOUNDATION` | `TBD` |
