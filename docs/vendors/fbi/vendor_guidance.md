# FBI — UCR / Crime — Data Guidance

⚠️ **INTERNAL — contract and operational context**

**Intake bundle:** `docs/vendors/fbi/` (machine column inventory + this narrative).  
**Canonical vendor hub:** `docs/vendor/fbi/` (dictionary + structured stubs).
...
| **vendor_id** | `VND_044` |
| **vendor_code** | `fbi` |
| **vendor_label** | FBI — UCR / Crime |
| **definition** | FBI Uniform Crime Reporting and related crime statistics as surfaced through Cybersyn tables |
...
## Vendor methodology (full text from `docs/vendor/fbi/fbi.md`)
...
|-----------|--------------|--------|-----------|------------|------------------|
| FBI_MAN_46C0F708 | pipeline | place | neutral | `RAW.FBI` | `TBD` |
