...
**Intake bundle:** `docs/vendors/hud/` (machine column inventory + this narrative).  
**Canonical vendor hub:** `docs/vendor/hud/` (dictionary + structured stubs).
...
| **vendor_code** | `hud` |
| **vendor_label** | HUD |
| **definition** | HUD Fair Market Rents Housing Choice Vouchers Qualified Census Tracts and Difficult Development Areas |
| **data_type** | administrative |
| **refresh_cadence** | annual |
| **contract_status** | active |
| **source_schema** | `RAW.HUD` |
| **data_share_type** | s3 |
| **vertical_codes** | — |
...
## Vendor methodology (full text from `docs/vendor/hud/hud.md`)

**Catalog row:** `vendor_id` = `VND_005` in `seeds/reference/catalog/vendor.csv`.

## 1. Identity

HUD Fair Market Rents Housing Choice Vouchers Qualified Census Tracts and Difficult Development Areas
...
See [VENDOR_CONCEPT_COVERAGE_MATRIX.md](../migration/VENDOR_CONCEPT_COVERAGE_MATRIX.md) for **`hud`** × concept × dataset gaps and stretch mappings.
...
| Metric | Value |
|--------|-------|
| **Unique physical columns** | 10 |
| **Rows pointing at TRANSFORM.DEV / DEV paths** | 10 |
| **Raw catalog metrics (metric.csv rows for this vendor)** | 10 |
...
|-----------|--------------|--------|-----------|------------|------------------|
| MET_013 | occupancy | housing | neutral | `TRANSFORM.DEV.FACT_HUD_HOUSING_SERIES_CBSA` | `VALUE` |
| MET_008 | occupancy | housing | neutral | `TRANSFORM.DEV.FACT_HUD_HOUSING_SERIES_COUNTY` | `VALUE` |
| HUD_MAN_9A0D0EBCC9 | pipeline | place | neutral | `TRANSFORM.DEV.FACT_HUD_OZ_TRACT` | `AREA_MFI` |
| HUD_MAN_BDBF45AE6A | pipeline | place | neutral | `TRANSFORM.DEV.FACT_HUD_OZ_TRACT` | `MFI_70_ELIGIBLE` |
| HUD_MAN_855C91A241 | pipeline | place | neutral | `TRANSFORM.DEV.FACT_HUD_OZ_TRACT` | `OZ2_ELIGIBLE_FLAG` |
| HUD_MAN_AA790CA8BF | pipeline | place | neutral | `TRANSFORM.DEV.FACT_HUD_OZ_TRACT` | `PCT_AREA_MFI` |
| HUD_MAN_442C5A4407 | pipeline | place | neutral | `TRANSFORM.DEV.FACT_HUD_OZ_TRACT` | `POVERTY_125_MFI_ELIGIBLE` |
| HUD_MAN_859747037C | pipeline | place | neutral | `TRANSFORM.DEV.FACT_HUD_OZ_TRACT` | `TRACT_MFI` |
| HUD_MAN_D4ECB309D3 | pipeline | place | neutral | `TRANSFORM.DEV.FACT_HUD_OZ_TRACT` | `TRACT_POVERTY_PCT` |
| MET_099 | occupancy | housing | neutral | `TRANSFORM.DEV.fact_hud_housing_series` | `VALUE` |
