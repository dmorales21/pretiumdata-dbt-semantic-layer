# First Street Foundation — Data Guidance

⚠️ **INTERNAL — contract and operational context**

**Intake bundle:** `docs/vendors/first_street/` (machine column inventory + this narrative).  
**Canonical vendor hub:** `docs/vendor/first_street/` (dictionary + structured stubs).
...
|-------|-------|
| **vendor_id** | `VND_023` |
| **vendor_code** | `first_street` |
| **vendor_label** | First Street Foundation |
| **definition** | First Street climate risk scores at property grain covering flood wildfire wind and heat risk |
| **data_type** | spatial |
| **refresh_cadence** | annual |
| **contract_status** | active |
| **source_schema** | `RAW.FIRST_STREET` |
| **data_share_type** | s3 |
| **vertical_codes** | — |

**Primary migration doc (inventory):** [migration/MIGRATION_TASKS_FIRST_STREET_RCA.md](../migration/MIGRATION_TASKS_FIRST_STREET_RCA.md)

---

## Vendor methodology (full text from `docs/vendor/first_street/first_street.md`)

**Catalog row:** `vendor_id` = `VND_023` in `seeds/reference/catalog/vendor.csv`.

## 1. Identity

First Street climate risk scores at property grain covering flood wildfire wind and heat risk
...
See [VENDOR_CONCEPT_COVERAGE_MATRIX.md](../migration/VENDOR_CONCEPT_COVERAGE_MATRIX.md) for **`first_street`** × concept × dataset gaps and stretch mappings.
...
Primary task / vet doc: [`migration/MIGRATION_TASKS_FIRST_STREET_RCA.md`](../migration/MIGRATION_TASKS_FIRST_STREET_RCA.md)
...
|-----------|--------------|--------|-----------|------------|------------------|
| FIRST_STREET_MAN_985AC0BA | pipeline | place | neutral | `RAW.FIRST_STREET` | `TBD` |
