# CFPB — HMDA — Data Guidance

⚠️ **INTERNAL — contract and operational context**

**Intake bundle:** `docs/vendors/cfpb/` (machine column inventory + this narrative).  
**Canonical vendor hub:** `docs/vendor/cfpb/` (dictionary + structured stubs).
...
| **vendor_id** | `VND_050` |
| **vendor_code** | `cfpb` |
| **vendor_label** | CFPB — HMDA |
| **definition** | Consumer Financial Protection Bureau Home Mortgage Disclosure Act and related complaint feeds |
| **data_type** | administrative |
| **refresh_cadence** | annual |
| **contract_status** | active |
| **source_schema** | `RAW.CFPB` |
| **data_share_type** | s3 |
| **vertical_codes** | — |
...
## Vendor methodology (full text from `docs/vendor/cfpb/cfpb.md`)

**Catalog row:** `vendor_id` = `VND_050` in `seeds/reference/catalog/vendor.csv`.

## 1. Identity

Consumer Financial Protection Bureau Home Mortgage Disclosure Act and related complaint feeds
...
See [VENDOR_CONCEPT_COVERAGE_MATRIX.md](../migration/VENDOR_CONCEPT_COVERAGE_MATRIX.md) for **`cfpb`** × concept × dataset gaps and stretch mappings.
...
|-----------|--------------|--------|-----------|------------|------------------|
| CFPB_MAN_DA4CFB5E | pipeline | place | neutral | `RAW.CFPB` | `TBD` |
