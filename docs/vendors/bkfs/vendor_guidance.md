# Black Knight Financial Services — Data Guidance

⚠️ **INTERNAL — contract and operational context**

**Intake bundle:** `docs/vendors/bkfs/` (machine column inventory + this narrative).  
**Canonical vendor hub:** `docs/vendor/bkfs/` (dictionary + structured stubs).
...
| **vendor_id** | `VND_012` |
| **vendor_code** | `bkfs` |
| **vendor_label** | Black Knight Financial Services |
| **definition** | Black Knight McDash loan-level mortgage data including loan characteristics current performance delinquency history and property attributes |
| **data_type** | transactional |
| **refresh_cadence** | monthly |
| **contract_status** | active |
| **source_schema** | `RAW.BKFS` |
| **data_share_type** | s3 |
| **vertical_codes** | red |
...
## Vendor methodology (full text from `docs/vendor/bkfs/bkfs.md`)

**Catalog row:** `vendor_id` = `VND_012` in `seeds/reference/catalog/vendor.csv`.

## 1. Identity

Black Knight McDash loan-level mortgage data including loan characteristics current performance delinquency history and property attributes
...
See [VENDOR_CONCEPT_COVERAGE_MATRIX.md](../migration/VENDOR_CONCEPT_COVERAGE_MATRIX.md) for **`bkfs`** × concept × dataset gaps and stretch mappings.
...
|-----------|--------------|--------|-----------|------------|------------------|
| BKFS_MAN_826A22F0 | pipeline | place | neutral | `RAW.BKFS` | `TBD` |
