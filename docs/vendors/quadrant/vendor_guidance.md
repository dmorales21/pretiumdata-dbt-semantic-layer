# Quadrant Information Services — Data Guidance

⚠️ **INTERNAL — contract and operational context**

**Intake bundle:** `docs/vendors/quadrant/` (machine column inventory + this narrative).  
**Canonical vendor hub:** `docs/vendor/quadrant/` (dictionary + structured stubs).
...
|-------|-------|
| **vendor_id** | `VND_028` |
| **vendor_code** | `quadrant` |
| **vendor_label** | Quadrant Information Services |
| **definition** | Quadrant insurance rate data by state used for underwriting expense modeling |
| **data_type** | survey |
| **refresh_cadence** | annual |
| **contract_status** | active |
| **source_schema** | `RAW.QUADRANT` |
| **data_share_type** | s3 |
| **vertical_codes** | — |
...
## Vendor methodology (full text from `docs/vendor/quadrant/quadrant.md`)

**Catalog row:** `vendor_id` = `VND_028` in `seeds/reference/catalog/vendor.csv`.

## 1. Identity

Quadrant insurance rate data by state used for underwriting expense modeling
...
See [VENDOR_CONCEPT_COVERAGE_MATRIX.md](../migration/VENDOR_CONCEPT_COVERAGE_MATRIX.md) for **`quadrant`** × concept × dataset gaps and stretch mappings.
...
|-----------|--------------|--------|-----------|------------|------------------|
| QUADRANT_MAN_2D34D036 | pipeline | place | neutral | `RAW.QUADRANT` | `TBD` |
