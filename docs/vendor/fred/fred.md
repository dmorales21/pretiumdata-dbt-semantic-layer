# Vendor: Federal Reserve — FRED (`fred`)
...
See [VENDOR_CONCEPT_COVERAGE_MATRIX.md](../migration/VENDOR_CONCEPT_COVERAGE_MATRIX.md) for **`fred`** × concept × dataset gaps and stretch mappings.
